...
def get_document_ocr_pages(file_id: str) -> list[dict[str, Any]]:
    return OCR_REPOSITORY.get_for_file(file_id)
...
def replace_document_ocr_pages(file_id: str, pages: list[dict[str, Any]]) -> None:
    OCR_REPOSITORY.replace_for_file(file_id, pages)
